                ...
                <div key={index} className={`grid lg:grid-cols-2 gap-16 items-center ${isEven ? '' : 'lg:grid-flow-col-dense'}`}>
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      <div className="absolute -top-6 -right-6 w-24 h-24 bg-vexa-gradient rounded-full opacity-80 animate-float"></div>
                      <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-vexa-gradient-reverse rounded-full opacity-60 animate-float" style={{ animationDelay: '1s' }}></div>
                    </div>
                  </AnimationWrapper>
                </div>
              );
